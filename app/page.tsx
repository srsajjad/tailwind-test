...
import { ChevronDown, Search, ShoppingCart, Truck, User } from "lucide-react";
        ...
        <div className="bg-white border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-end space-x-4 py-2 text-sm">
              ...
              <a href="/inquiry" className="text-gray-500 hover:text-gray-700">
                Send Inquiry
              </a>
                ...
                <div className="hidden md:block">
                  <div className="relative">
                    <input
                      type="text"
                      placeholder="Search"
                      className="w-64 pl-3 pr-10 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-500"
                    />
